...
let ddlParensDoc (cfg: Style) : ParenthesisCombinator =
    parens (optWhen cfg.ddl.indentParenthesesContents cfg.whitespace.numberOfSpacesInTabs) cfg.ddl.parenthesisStyle
...
let cteBodyParensDoc (cfg: Style) : ParenthesisCombinator =
    parens (optWhen cfg.cte.indentContents cfg.whitespace.numberOfSpacesInTabs) cfg.cte.parenthesisStyle
